<template>
  <div class="container" :class="{ 'sign-up-mode': show}">
    <div class="forms-container" >
      <div class="signin-signup">
        <form action="#" class="sign-in-form">
          <h2 class="title" >登录</h2>
          <div class="input-field">
            <i class="fas fa-user"><el-icon :size="20"><User /></el-icon></i>
            <input type="text" placeholder="用户名" />
          </div>
          <div class="input-field">
            <i class="fas fa-lock"><el-icon :size="20"><Lock /></el-icon></i>
            <input type="password" placeholder="密码" />
          </div>
          <button class="btn solid" @click="login">立即登录</button>
...
const login = ()=>{
  store.commit('setifshowimg', {
    ...
    console.log(store.state.ifshowimg);
}
</script>
<style scoped>
